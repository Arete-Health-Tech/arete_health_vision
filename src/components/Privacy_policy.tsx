        ...
        <div className={styles.content}>
          ...
          <div className={styles.section}>
            <p className={styles.paragraph}>
              ...
              ("Company" or "we" or "our" or "us"), owns and operates its
              websites and digital offerings, including any associated mobile
              applications and digital platforms (collectively referred to as
              the “Platforms”).
            </p>
            ...
            <p className={styles.paragraph}>
              This Privacy Policy sets out how we collect, use, store, share,
              and protect the personal and sensitive information of our users,
              including employees, contractors, vendors, business partners,
              their customers/patients, and visitors to our Platforms
              (collectively referred to as “Users” or “You” or “Your”).
            </p>

            <p className={styles.paragraph}>
              By accessing or using our Platforms and/or submitting your
              information to us, you agree that you have read, understood, and
              consented to the practices described in this Privacy Policy. If
              you do not agree with this Privacy Policy, please do not use the
              Platforms. If you are accessing the Platforms on behalf of another
              individual or entity, you represent that you are authorized to do
              so and to consent on their behalf.
            </p>
          ...
          <div className={styles.section}>
            ...
            <ul className={styles.list}>
              ...
              <li>
                ...
                conditions, biometric information, etc., which are collected
                only with your explicit consent.
              </li>
              <li>
                Non-Personal Information includes demographic details, browser
                types, geolocation, IP address, device information, etc., which
          ...
          <div className={styles.section}>
            ...
            <p className={styles.paragraph}>
              We may use your Personal Information and SPDI for purposes such
              as:
            </p>
          ...
          <div className={styles.section}>
            ...
            <ul className={styles.list}>
              <li>
                Clients or Partners: Based on your interactions with our
                Platforms and subject to your consent.
              </li>
              <li>
          ...
          <div className={styles.section}>
            ...
            <p className={styles.paragraph}>
              We retain your Personal Information and SPDI as long as necessary
              to provide our services and comply with legal obligations. On
              request, and where permissible, we may delete your data, excluding
              anonymized records and data retained for legal compliance.
            </p>
          </div>
          ...
          <div className={styles.section}>
            ...
            <ul className={styles.list}>
              ...
              <li>
                For any grievances related to data privacy, contact our
          ...
          <div className={styles.section}>
            ...
            <p className={styles.paragraph}>
              ...
              Please review this document periodically for changes. Continued
              use of the Platforms after updates constitutes acceptance of the
              revised policy.
            </p>
          </div>
